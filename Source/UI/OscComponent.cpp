...
OscComponent::OscComponent(juce::AudioProcessorValueTreeState& apvts, juce::String oscSelectorId, juce::String fmFreqId, juce::String fmDepthId)
{
    ...
    Styles::setComboBox(oscSelector, *this, juce::Colour(0xFF809bce));
    Styles::setRotarySlider(fmFreqSlider, fmFreqLabel, *this, juce::Colour(0xFF809bce));
    Styles::setRotarySlider(fmDepthSlider, fmDepthLabel, *this, juce::Colour(0xFF809bce));
}
