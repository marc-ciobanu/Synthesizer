...
public:
    ...
    //void updateEq(double sampleRate, float peakFreq, float peakQuality, float peakGainInDecibels, float lowCutFreq, float highCutFreq, Slope lowCutSlope, Slope highCutSlope);
